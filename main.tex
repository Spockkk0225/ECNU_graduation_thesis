...
\documentclass[12pt,a4paper,fancyhdr,openright,oneside]{ctexbook}
...
\usepackage{fancyhdr}
\usepackage{graphicx}
\usepackage{indentfirst,latexsym,amsthm,colortbl,clrscode}
...
\fancyhead[CO,CE]{\small 华东师范大学硕士学术学位论文}  % 页眉居中

% \fancyhead[LO,LE]{\small 华东师范大学硕士学位学位论文}    % 页眉居左
...
\input C2-RelatedWork.tex
\input C3.1-Preliminaries.tex
\input C3.2-RFS.tex
\input C3.3-DRFS.tex
\input C3.4-LS.tex
\input C3.5-KernelFunction.tex
\input C3.6-Exp.tex
\input C4-Distribution.tex
\input C5-Conclusion.tex
